<template>
    ...
    :class="{'h-[350px]': !isTablet, 'h-[194px]': isTablet}">
        <div class="min-w-[350px] w-[424px] h-full py-3 px-2 flex flex-col items-center justify-center">
            ...
            <RouterLink to="/" class="w-[255px] py-3 flex items-center justify-center rounded-3xl bg-black text-white">Купить<span>
                <img src="~/public/img/arrowRight.svg" width="25" height="25" alt="buy icon" />
            </span> </RouterLink>
        </div>
        <div>
